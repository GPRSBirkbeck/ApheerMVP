...
public class LocationListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LocationListAdapter(OnPictureListener onPictureListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FormerLocationsViewholder(view, onPictureListener);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        StorageReference locationPictures = mStorageReference.child("cityPictures/" + mFormerLocations.get(position).getLocationId());
